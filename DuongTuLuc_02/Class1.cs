    ...
    class Class1
    {
        ...
        static void menu()
        {
            ...
            do
            {
                ...
                Console.WriteLine("4.Thong ke luong thuc lanh trung binh phai tra cho nhan vien.");
                ...
                switch (chon)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Console.WriteLine($"Tong tien luong thuc lanh trung binh phai tra: {ql.tinhTongLuong():#,##0 vnd}");
                        break;
                    case 0:
